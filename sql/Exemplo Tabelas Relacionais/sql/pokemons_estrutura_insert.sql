...
--EXERCICIO 1 (Selecione todas as colunas)
SELECT id, nome, codigo, categoria, altura, peso, hp, ataque, defesa, especial_ataque, especial_defesa, velocidade, descricao 
	FROM pokemons

--EXERCICIO 2 (Selecione o ataque, ataque especial, defesa e defesa especial)
SELECT ataque, especial_ataque, defesa, especial_defesa FROM pokemons

--EXERCICIO 3 (Selecione nome, categoria e ataque ordenado pelo ataque em ordem crescente)	
SELECT nome, categoria, ataque 
	FROM pokemons 
	ORDER BY ataque ASC

--EXERCICIO 4 (Selecione altura, peso, com o cálculo do imc)
SELECT peso,altura,(peso/(altura*altura)) AS 'IMC'
	FROM pokemons 
	GROUP BY peso, altura

-- 5. Selecione altura, peso, com o cálculo do imc ordenando o imc em ordem decrescente.
SELECT nome, altura, ROUND( peso/(altura*altura),2) AS 'IMC' 
	FROM pokemons
	ORDER BY IMC DESC	

--6. Selecione nome e o tamanho do nome em ordem decrescente pelo nome
SELECT nome, LEN(nome) AS p_NOME
	FROM pokemons
	ORDER BY p_NOME DESC
...
SELECT AVG(ataque) AS Medias_ataques
	FROM pokemons

--11. Selecione a somatória dos ataques.
SELECT SUM(ataque) AS Soma_Ataques
	FROM pokemons

--12. Selecione a média dos ataques especiais quando o nome do pokemon começar com ‘P’
--SELECT nome, (especial_ataque+especial_defesa/2) AS Medias_ataques
--	FROM pokemons
--	WHERE nome LIKE 'P%'
